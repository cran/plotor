...
vignette: >
  %\VignetteIndexEntry{plot_or: Forest plots for logistic regression}
...
- **Horizontal lines**: 95% confidence intervals (can be configured by setting parameter `conf_level`)
...
- Consistent with your table labels (see `vignette("table_or")`)
...
- `ggplot2::ggplot()` - ggplot2 documentation for further cusomisation

- `ggplot2::ggsave()` - saving and exporting plots